...
import speedith.core.reasoning.rules.cop.TRAddSpider;
import speedith.ui.selection.SelectionDialog;

public class TestingFormTRAddSpider extends javax.swing.JFrame {

    public TestingFormTRAddSpider() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InferenceRule<RuleArg> addSpider = (InferenceRule<RuleArg>) InferenceRules.getInferenceRule(TRAddSpider.InferenceRuleName);
        RuleApplicationInstruction<?> instructions = addSpider.getProvider().getInstructions();
        ...
        if (!dsd.isCancelled()) {
            ...
            try {
                proofPanel1.applyRule(addSpider, ruleArg, RuleApplicationType.INTERACTIVE,"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestingFormTRAddSpider.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TestingFormTRAddSpider().setVisible(true);
            }
        });
    }
