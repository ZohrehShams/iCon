...
import speedith.core.reasoning.rules.cop.TRAddShading;
import speedith.core.reasoning.rules.cop.TRAddUnCurve;
import speedith.ui.automatic.InteractiveRuleAppliedEvent;
import speedith.ui.rules.InteractiveRuleApplication;
import speedith.ui.selection.SelectionDialog;

public class TestingFormTRAddUnCurve extends javax.swing.JFrame {

    public TestingFormTRAddUnCurve() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //proofPanel1 = new ProofPanel(Goals.createGoalsFrom(SpeedithMainForm2.getExampleE()));
        proofPanel1 = new ProofPanel(Goals.createGoalsFrom(SpeedithMainForm.getExampleELUCOP()));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InferenceRule<RuleArg> addUnCurve = (InferenceRule<RuleArg>) InferenceRules.getInferenceRule(TRAddUnCurve.InferenceRuleName);
        RuleApplicationInstruction<?> instructions = addUnCurve.getProvider().getInstructions();
        ...
        if (!dsd.isCancelled()) {
            ...
            try {
                proofPanel1.applyRule(addUnCurve, ruleArg, RuleApplicationType.INTERACTIVE,"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestingFormTRAddUnCurve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TestingFormTRAddUnCurve().setVisible(true);
            }
        });
    }
