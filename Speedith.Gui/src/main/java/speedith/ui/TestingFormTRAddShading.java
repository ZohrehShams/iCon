...
public class TestingFormTRAddShading extends javax.swing.JFrame {

    public TestingFormTRAddShading() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //proofPanel1 = new ProofPanel(Goals.createGoalsFrom(SpeedithMainForm.getExampleACOP()));
        //proofPanel1 = new ProofPanel(Goals.createGoalsFrom(SpeedithMainForm.getExampleD()));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InferenceRule<RuleArg> splitSpiders = (InferenceRule<RuleArg>) InferenceRules.getInferenceRule(TRAddShading.InferenceRuleName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestingFormTRAddShading.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TestingFormTRAddShading().setVisible(true);
            }
        });
    }
