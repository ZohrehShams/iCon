...
import speedith.core.reasoning.rules.cop.TRAddCurveLabel;
import speedith.core.reasoning.rules.cop.TRAddShading;
import speedith.ui.selection.SelectionDialog;

import javax.swing.JOptionPane;

public class TestingFormTRAddCurveLabel extends javax.swing.JFrame {

    public TestingFormTRAddCurveLabel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //proofPanel1 = new ProofPanel(Goals.createGoalsFrom(SpeedithMainForm.getExampleG()));
        proofPanel1 = new ProofPanel(Goals.createGoalsFrom(SpeedithMainForm.getExampleDLUCOP()));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InferenceRule<RuleArg> addCurveLabel = (InferenceRule<RuleArg>) InferenceRules.getInferenceRule(TRAddCurveLabel.InferenceRuleName);
        RuleApplicationInstruction<?> instructions = addCurveLabel.getProvider().getInstructions();
        ...
        if (!dsd.isCancelled()) {
            ...
            try {
                proofPanel1.applyRule(addCurveLabel, ruleArg, RuleApplicationType.INTERACTIVE,"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestingFormTRAddCurveLabel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TestingFormTRAddCurveLabel().setVisible(true);
            }
        });
    }
