...
import speedith.core.reasoning.rules.transformers.copTrans.SwapDashedWithSolidArrowTransformer;
 ...
 * an unnamed curve that contains the target of the arrow, and add a solid arrow from the source of the dashed arrow to this curve.
 * @author Zohreh Shams
 */
public class SwapDashedWithSolidArrow extends SimpleInferenceRule<ArrowArg> 
implements BasicInferenceRule<ArrowArg>, ForwardRule<ArrowArg>, Serializable{
	...
	public static final String InferenceRuleName = "swap-dashed_with_solid_arrow";
	...
	public String getDescription(Locale locale) {
		return Translations.i18n(locale, "SWAP_DASHED_WITH_SOLID_ARROW_DESCRIPTION");
	}
	
	
	@Override
	public String getPrettyName(Locale locale) {
		return Translations.i18n(locale, "SWAP_DASHED_WITH_SOLID_ARROW_PRETTY_NAME");
	}
    ...
    private RuleApplicationResult apply(ArrowArg targetArrow, Goals goals) throws RuleApplicationException {
        ...
        newSubgoals[targetArrow.getSubgoalIndex()] = 
        		targetSubgoal.transform(new SwapDashedWithSolidArrowTransformer(targetArrow, true));
