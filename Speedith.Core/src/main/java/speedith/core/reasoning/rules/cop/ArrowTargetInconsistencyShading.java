 ...
 * shaded curve target, and there is an arrow in the other conjunct with the same label and source but to a spider target.
 * @author Zohreh Shams
 */
...
implements BasicInferenceRule<MultipleRuleArgs>, ForwardRule<MultipleRuleArgs>, Serializable{
	...
	public static final String InferenceRuleName = "arrow_target_incons";
